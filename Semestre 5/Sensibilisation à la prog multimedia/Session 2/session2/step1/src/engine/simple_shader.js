...
function loadAndCompileShader(filePath, shaderType) {
    ...
    try {
        ...
        throw new Error("Failed to load shader: " + filePath + " [Hint: you cannot double click index.html to run this project. " + "The index.html file must be loaded by a web-server.]");
            return null;
    }
