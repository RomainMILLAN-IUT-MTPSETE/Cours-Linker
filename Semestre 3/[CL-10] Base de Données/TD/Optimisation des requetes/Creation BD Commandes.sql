...
INSERT INTO Clients (SELECT * FROM Palleja.OPT3_Clients);
INSERT INTO Produits (SELECT * FROM Palleja.OPT3_Produits);
INSERT INTO Commandes (SELECT * FROM Palleja.OPT3_Commandes);
INSERT INTO LignesCommande (SELECT * FROM Palleja.OPT3_LignesCommande);
